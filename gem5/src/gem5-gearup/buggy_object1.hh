...
#include "mem/port.hh"
#include "params/BuggyObject1.hh"
 ...
 * CPU.
 */
class BuggyObject1 : public SimObject
{
  private:
    /**
     ...
     */
     class CpuSidePort : public ResponsePort
     {
      ...
      public:
       ...
       public:
         CpuSidePort(const std::string& name, BuggyObject1 *owner) :
     ...
     class MemSidePort : public RequestPort
     {
      ...
      public:
       ...
       public:
         MemSidePort(const::std::string& name, BuggyObject1 *owner) :
  ...
  public:
    /** Constructor */
    BuggyObject1(const BuggyObject1Params &params);
