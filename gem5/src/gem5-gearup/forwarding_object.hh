...
#include "mem/port.hh"
#include "params/ForwardingObject.hh"
 ...
 * CPU.
 */
class ForwardingObject : public SimObject
{
  private:
    /**
     ...
     */
     class CpuSidePort : public ResponsePort
     {
      ...
      public:
       ...
       public:
         CpuSidePort(const std::string& name, ForwardingObject *owner) :
     ...
     class MemSidePort : public RequestPort
     {
      ...
      public:
       ...
       public:
         MemSidePort(const::std::string& name, ForwardingObject *owner) :
  ...
  public:
    /** Constructor */
    ForwardingObject(const ForwardingObjectParams &params);
