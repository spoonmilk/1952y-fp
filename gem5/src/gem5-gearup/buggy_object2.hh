...
#include "mem/port.hh"
#include "params/BuggyObject2.hh"
...
/**
 * Example 1: An object that takes information from the CPU and sends it
 * to memory. Similarly, gets responses from memory and sends them to the
 * CPU.
 */
class BuggyObject2 : public SimObject
{
  private:
    /**
     ...
     */
	 ...
	 int count;
      ...
      public:
       ...
       public:
         CpuSidePort(const std::string& name, BuggyObject2 *owner) :
             ResponsePort(name), owner(owner), needRetry(false), count(0)
         {  };
     ...
     class MemSidePort : public RequestPort
     {
      ...
      public:
       ...
       public:
         MemSidePort(const::std::string& name, BuggyObject2 *owner) :
  ...
  public:
    /** Constructor */
    BuggyObject2(const BuggyObject2Params &params);
